...
read_globals = {
    -- Namespaces
    "C_AddOns", "C_DamageMeter", "C_PaperDollInfo", "C_Spell", "C_SpecializationInfo", "C_Timer",
    "C_UnitAuras", "AuraUtil", "Enum", "Settings", "MinimalSliderWithSteppersMixin",
    ...
    "UnitExists", "UnitCanAttack", "IsInGroup",
